...
<div class="toc">
  ...
  <ul>
    ...
    <li><a href="#scala_android_library">scala_android_library</a></li>
  </ul>
</div>
...
<a name="scala_android_library"></a>
## scala\_android_library

`scala_android_library` allows you to write Android applications in scala and create libraries that incorporate Android APIs.
...
# BUILD
load("//scala:scala_android.bzl", "scala_android_library")
...
<table class="table table-condensed table-bordered table-params">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p><code>List of labels, optional</code></p>
        <p>List of Android resource files to include in this library target</p>
      </td>
    </tr>
    <tr>
      <td><code>manifest</code></td>
      <td>
        <p><code>String, optional (required if resource_files are present)</code></p>
        <p>List of Android resource files to include in this library target</p>
      </td>
    </tr>
    <tr>
      <td><code>proguard_specs</code></td>
      <td>
        <p><code>List of labels, optional</code></p>
        <p>List of proguard rules this library target will be processed with</p>
      </td>
    </tr>
  </tbody>
</table>
