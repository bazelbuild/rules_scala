...
import bazel_test_runner.junitrunner.java.com.google.testing.junit.runner.internal.StackTraces;
...
public class BazelTestRunner {
  ...
  private static int runTestsInSuite(String suiteClassName, String[] args) {
    ...
    JUnit4Runner runner =
        JUnit4Bazel.builder()
            .suiteClass(new JUnit4InstanceModules.SuiteClass(suite))
            .config(new JUnit4InstanceModules.Config(args))
            .build()
            .runner();
