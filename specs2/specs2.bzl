...
def specs2_repositories(scala_version = _default_scala_version(), maven_servers = ["http://central.maven.org/maven2"]):
  ...
  _scala_maven_import_external(
      ...
      artifact = _scala_mvn_artifact("org.specs2:specs2-core:" + specs2_version(), major_version),
  ...
  _scala_maven_import_external(
      ...
      artifact = _scala_mvn_artifact("org.specs2:specs2-common:" + specs2_version(), major_version),
  ...
  _scala_maven_import_external(
      ...
      artifact = _scala_mvn_artifact("org.specs2:specs2-matcher:" + specs2_version(), major_version),
  ...
  _scala_maven_import_external(
      ...
      artifact = _scala_mvn_artifact("org.scalaz:scalaz-effect:7.2.7", major_version),
  ...
  _scala_maven_import_external(
      ...
      artifact = _scala_mvn_artifact("org.scalaz:scalaz-core:7.2.7", major_version),
