...
def specs2_junit_repositories(scala_version = _default_scala_version(), maven_servers = ["http://central.maven.org/maven2"]):
  ...
  _scala_maven_import_external(
      ...
      artifact = _scala_mvn_artifact("org.specs2:specs2-junit:" + specs2_version(), major_version),
