...
after the `java_proto_library` rules. This as a result does use aspects for good caching and speed, this however places some limitations on how some scala authors are used to working with scalapb.
