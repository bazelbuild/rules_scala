...
import third_party.plugin.src.main.io.bazel.rulesscala.dependencyanalyzer.DependencyContext._
...
class DependencyAnalyzer(val global: CallbackGlobal) extends  LocateClassFile with GlobalHelpers {
...
//        val fromClassName = classNameAsString(dep.from)
        ...
        def binaryDependency(file: File, binaryClassName: String) = {throw new RuntimeException("binaryDependency")}
...
//          (NoSymbol, false)
      ...
      private def addClassDependency(
        ...
        println("addClassDependency: " + fromClass)
