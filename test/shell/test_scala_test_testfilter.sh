...
test_scala_test_testfilter_class_selection() {
  bazel test --test_output=errors --test_filter=A //test/scala_test_testfilter:tests
}

test_scala_test_testfilter_method_selection() {
  bazel test --test_output=errors --test_filter=A --test_arg=-t --test_arg="test 1" //test/scala_test_testfilter:tests
}
