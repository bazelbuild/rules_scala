...
def pack_sources_test_suite(name):
    single_source_jar_test(name = "single_source_jar_test",
                           target_under_test = ":source_jar")
    multi_source_jar_test(name = "multi_source_jar_test",
                           target_under_test = ":multi_source_jar")
    source_jar_with_srcs_test(name = "source_jar_with_srcs_test",
