...
def _rule_impl(ctx):
  expected_deps = {
      "scala_library": [
          ...
          "@scala_default_imports//:scala-library",
      ],
      "scala_test": [
          "//test/aspect:scala_test",
          "@scala_default_imports//:scala-library",
          "@scalatest_2_11//jar:jar",
      ],
      "scala_junit_test": [
      ...
      "scala_specs2_junit_test": [
          ...
          "@scala_xml_2_11//jar:jar",
          "@scala_parser_combinators_2_11//jar:jar",
          "@scala_default_imports//:scala-library",
          "@scala_default_imports//:scala-reflect",
